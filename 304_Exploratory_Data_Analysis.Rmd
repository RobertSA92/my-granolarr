...
The violin plot illustrates the different distributions to greater effect. The box plot shows the range and medians but is not affected by the distribution of the data. The box and whisker plot implies there are more 20 to 24 years olds living in areas than any other OAC. However, with the violin graph we can see population being more accurately reflected. This shows Cosmopolitans areas having a greater range but less densitiy. The graph shows a greater density of 20 - 24 year olds living in Multicultural Metropolitans than what was impled in the box-whisker plot. 
